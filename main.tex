...
\{\bytecode\ \} \texttt{ catch } \{\bytecode'\} \end{array} &\equiv& \left\{
    \begin{array}{l}
        \call{a,f,E_0,\dots,E_n,E_\textrm{gas}}; \\
